...
import Form from "./components/formPenemuan";
...
export default function Penemuan() {
    ...
    useEffect(() => {
        onSnapshot(query(collection(db, "penemuan"), orderBy("pembuatan", "desc")), snapshot => {
            ...
            <Dialog
               ...
               overflow-y font-qs"            >
                <Dialog.Panel className="relative p-8">
                    ...
                    <p>Nama penemu: {props.barang.nama}</p>
                    <p>Tempat penemuan: {props.barang.tempat}</p>
                    <p>Kontak penemu: {props.barang.kontak}</p>
